...
import { initializeBingoCardBoard, toggleNumberSelection } from "../../../reducer/Bingo/bingo.action";
      ...
      {bingoNumbersCardBoard.map((bingoNumber, index) => (
        <div 
          ...
          onClick={() => !play && calledNumbers.includes(bingoNumber.id) && 
            toggleNumberSelection(bingoNumber.id, index, bingoNumbersCardBoard, setBingoNumbersCardBoard)}
        >
